...
const ApperanceSidebar = ({ className }: { className?: string }) => {
  const {
    bgColor,
    setBgColor,
    setDotsColor,
            ...
            {markerBorders.map((item) => (
              <div
                ...
                className={cn(
                  ...
                  JSON.stringify(item.value) === JSON.stringify(eyeRadiusOuter)
          ...
          <div className="grid grid-cols-3 gap-4">
            {markerBorders.map((item) => (
              <div
                ...
                className={cn(
                  "flex items-center justify-center group aspect-square border rounded-lg transition cursor-pointer",
                  JSON.stringify(item.value) === JSON.stringify(eyeRadiusInner)
                    ? "border-blue-600 bg-blue-50 hover:bg-blue-100"
                    : "hover:bg-gray-50"
                )}
              >
